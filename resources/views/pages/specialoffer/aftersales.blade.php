...
<div class="relative">
    <img src="{{ asset('image/image_header_spesial_offer.jpg') }}" class="w-full h-[550px] object-cover hidden md:block bg-gray-300">
    <img src="{{ asset('image/Bitmap1.jpg') }}" class="w-full block md:hidden bg-gray-300">
    ...
    <div class="my-24 space-y-8">
        <div class="grid md:grid-cols-2 gap-4 md:gap-8">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <a href="{{ route('aftersales.detail', ['id' => '21', 'slug' => \Str::slug('iXclusive Breakfast at Pison Cafe Thamrin: A Blend of Breakfast, BMW iX, and Sustainability.')]) }}" class="buttons blue rounded-none text-base min-w-60">
                        Read More
                    </a>
                </div>
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-4 md:gap-8">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <a href="{{ route('aftersales.detail', ['id' => '41', 'slug' => \Str::slug('Sime Darby Motors Hadir di Indonesia')]) }}" class="buttons blue rounded-none text-base min-w-60">
                        Read More
                    </a>
                </div>
            </div>
